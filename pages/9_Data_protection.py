...
from st_helper_func import remove_top_space_canvas, disable_sidebar, hide_streamlit_footer
...
st.header("COLLECTION, USE AND DISCLOSURE OF PERSONAL DATA")
st.markdown("""
...
st.header("WITHDRAWING YOUR CONSENT")
st.markdown("""
    ...
    10. Whilst we respect your decision to withdraw your consent, please note that depending on the nature and scope of your request, we may not be in a position to continue providing our goods  5  SAMPLE CLAUSES AND TEMPLATES FOR CUSTOMERS (published 17 October 2017) or services to you and we shall, in such circumstances, notify you before completing the processing of your request. Should you decide to cancel your withdrawal of consent, please inform us in writing in the manner described in clause 8 above.
...
st.header("ACCESS TO AND CORRECTION OF PERSONAL DATA")
st.markdown("""
...
st.header("PROTECTION OF PERSONAL DATA")
st.markdown("""
...
st.header("ACCURACY OF PERSONAL DATA")
st.markdown("""
    17. We generally rely on personal data provided by you (or your authorised representative). In order to ensure that your personal data is current, complete and accurate, please update us if there are changes to your personal data by informing our Data Protection Officer in writing or via email at the contact details provided below. 
""")
st.markdown("---")

st.header("RETENTION OF PERSONAL DATA")
st.markdown("""
...
st.header("TRANSFERS OF PERSONAL DATA OUTSIDE OF SINGAPORE")
st.markdown("""
...
st.markdown("""
    21. You may contact the institution's Data Protection Officer (DPO) if you have any enquiries or feedback on our personal data protection policies and procedures, or if you wish to make any request, in the following manner:
...
st.markdown("""Effective date: 4 Jun 2023""")
st.markdown("""Last updated date: 4 Jun 2023""")